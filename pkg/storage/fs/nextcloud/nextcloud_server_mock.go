...
var responses = map[string]Response{
	...
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/"},"mdKeys":null} EMPTY`: {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/"},"mdKeys":null} HOME`:  {200, `{ "size": 1, "path":"/", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }`, serverStateHome},

	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/newdir"},"mdKeys":null} EMPTY`:         {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/newdir"},"mdKeys":null} HOME`:          {404, ``, serverStateHome},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/newdir"},"mdKeys":null} SUBDIR`:        {404, ``, serverStateSubdir},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/newdir"},"mdKeys":null} NEWDIR`:        {200, `{ "size": 1, "path":"/newdir", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }`, serverStateNewdir},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/newdir"},"mdKeys":null} SUBDIR-NEWDIR`: {200, `{ "size": 1, "path":"/newdir", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }`, serverStateSubdirNewdir},

	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/new_subdir"},"mdKeys":null}`: {200, `{ "size": 1 }`, serverStateEmpty},

	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdir"},"mdKeys":null} EMPTY`:         {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdir"},"mdKeys":null} HOME`:          {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdir"},"mdKeys":null} NEWDIR`:        {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdir"},"mdKeys":null} RECYCLE`:       {404, ``, serverStateRecycle},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdir"},"mdKeys":null} SUBDIR`:        {200, `{ "size": 1, "path":"/subdir", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }`, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdir"},"mdKeys":null} SUBDIR-NEWDIR`: {200, `{ "size": 1, "path":"/subdirh", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }`, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdir"},"mdKeys":null} METADATA`:      {200, `{ "size": 1,, "path":"/subdir", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }`, serverStateMetadata},

	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdirRestored"},"mdKeys":null} EMPTY`:         {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdirRestored"},"mdKeys":null} RECYCLE`:       {404, ``, serverStateRecycle},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdirRestored"},"mdKeys":null} SUBDIR`:        {404, ``, serverStateSubdir},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/subdirRestored"},"mdKeys":null} FILE-RESTORED`: {200, `{ "size": 1, "path":"/subdirRestored", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }`, serverStateFileRestored},

	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/versionedFile"},"mdKeys":null} EMPTY`:         {200, `{ "size": 2, "path":"/versionedFile", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }`, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/GetMD {"ref":{"path":"/versionedFile"},"mdKeys":null} FILE-RESTORED`: {200, `{ "size": 1, "path":"/versionedFile", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }`, serverStateFileRestored},
	...
	`POST /apps/sciencemesh/~einstein/api/ListFolder {"ref":{"path":"/"},"mdKeys":null}`: {200, `[{ "size": 1, "path":"/subdir", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }]`, serverStateEmpty},

	`POST /apps/sciencemesh/~einstein/api/ListFolder {"ref":{"path":"/Shares"},"mdKeys":null} EMPTY`:     {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/ListFolder {"ref":{"path":"/Shares"},"mdKeys":null} SUBDIR`:    {404, ``, serverStateSubdir},
	`POST /apps/sciencemesh/~einstein/api/ListFolder {"ref":{"path":"/Shares"},"mdKeys":null} REFERENCE`: {200, `[{ "size": 1, "path":"/Shares/reference", "metadata": { "foo": "bar" }, "etag": "in-json-etag", "mimetype": "in-json-mimetype" }]`, serverStateReference},

	`POST /apps/sciencemesh/~einstein/api/ListGrants {"ref":{"path":"/subdir"},"mdKeys":null} SUBDIR`:        {200, `[]`, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/ListGrants {"ref":{"path":"/subdir"},"mdKeys":null} GRANT-ADDED`:   {200, `[ { "stat": true, "move": true, "delete": false } ]`, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/ListGrants {"ref":{"path":"/subdir"},"mdKeys":null} GRANT-UPDATED`: {200, `[ { "stat": true, "move": true, "delete": true } ]`, serverStateEmpty},
