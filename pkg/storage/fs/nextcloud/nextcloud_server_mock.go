...
var responses = map[string]Response{
	...
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/"} EMPTY`: {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/"} HOME`:  {200, `{ "size": 1 }`, serverStateHome},

	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/newdir"} EMPTY`:         {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/newdir"} HOME`:          {404, ``, serverStateHome},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/newdir"} SUBDIR`:        {404, ``, serverStateSubdir},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/newdir"} NEWDIR`:        {200, `{ "size": 1 }`, serverStateNewdir},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/newdir"} SUBDIR-NEWDIR`: {200, `{ "size": 1 }`, serverStateSubdirNewdir},

	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/new_subdir"}`: {200, `{ "size": 1 }`, serverStateEmpty},

	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdir"} EMPTY`:         {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdir"} HOME`:          {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdir"} NEWDIR`:        {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdir"} RECYCLE`:       {404, ``, serverStateRecycle},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdir"} SUBDIR`:        {200, `{ "size": 1 }`, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdir"} SUBDIR-NEWDIR`: {200, `{ "size": 1 }`, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdir"} METADATA`:      {200, `{ "size": 1, "metadata": { "foo": "bar" } }`, serverStateMetadata},

	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdirRestored"} EMPTY`:         {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdirRestored"} RECYCLE`:       {404, ``, serverStateRecycle},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdirRestored"} SUBDIR`:        {404, ``, serverStateSubdir},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/subdirRestored"} FILE-RESTORED`: {200, `{ "size": 1 }`, serverStateFileRestored},

	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/versionedFile"} EMPTY`:         {200, `{ "size": 2 }`, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/GetMD {"path":"/versionedFile"} FILE-RESTORED`: {200, `{ "size": 1 }`, serverStateFileRestored},
	...
	`POST /apps/sciencemesh/~einstein/api/storage/ListFolder {"path":"/"}`: {200, `["/subdir"]`, serverStateEmpty},

	`POST /apps/sciencemesh/~einstein/api/storage/ListFolder {"path":"/Shares"} EMPTY`:     {404, ``, serverStateEmpty},
	`POST /apps/sciencemesh/~einstein/api/storage/ListFolder {"path":"/Shares"} SUBDIR`:    {404, ``, serverStateSubdir},
	`POST /apps/sciencemesh/~einstein/api/storage/ListFolder {"path":"/Shares"} REFERENCE`: {200, `["reference"]`, serverStateReference},
